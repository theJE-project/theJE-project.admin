		...
		<div class="layout-page">
			...
			<!-- Content -->
					...
					<div class="container-fluid flex-grow-1 container-p-y">
						<h4 class="fw-bold">
							<span class="text-muted fw-light">테이블</span> locations
						</h4>
						...
						<!-- Basic Buttons -->
							<div class="col-12">
								<div class="card mb-4">
									...
									<form id="searchForm" name="searchForm" action="/table/locations/list" method="post">
									...
									<div class="card-footer">
										...
										<button type="button" class="btn btn-secondary" id="searchClear" data-reset="locations">
											<span class="tf-icons bx bx-reset"></span>&nbsp; 리셋
			                            </button>
			                            <button type="button" class="btn btn-info" data-url="/table/locations/add" data-type="add"
			                            	data-bs-toggle="modal" data-bs-target="#modalData">
											<span class="tf-icons bx bx-plus"></span>&nbsp; 등록
			                            </button>
			                            <button type="button" class="btn btn-danger" data-url="/table/locations/remove">
										...
										<table class="table table-bordered" id="tableList">
											<thead>
												<tr>
													...
													<th class="center">lat</th>
													<th class="center">lng</th>
												</tr>
											</thead>
										...
										<c:if test="${TOTAL ne 0}">
											<c:forEach var="entry" items="${LIST}" varStatus="status">
												...
												<c:set var="pageNo" value="${PAGE.total - ( (PAGE.page-1) * PAGE.rows ) - no + 1 }" />
													...
													<td class="center">
														<a href="#" class="link_modal green" data-url="/table/locations/detail" data-modaltype="detail"
															data-detailkey="id" data-detailvalue="${entry.id}"
															data-bs-toggle="modal" data-bs-target="#modalData">${entry.id}</a>
													</td>
													<td class="center">${entry.city}</td>
													<td class="center">${entry.district}</td>
													<td class="right digits">${entry.lat}</td>
													<td class="right digits">${entry.lng}</td>
												</tr>
												...
												<form id="dataForm" name="dataForm" action="/table/pg_code/" method="post">
													...
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="modal-title"><sapn id="modalTitle">locations</sapn></h5>
														...
														<div class="modal-body">
															<div class="row g-2">
																...
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >CITY</label>
																	<input type="text" class="form-control" id="data_CITY" name="data_CITY" maxlength="255">
																</div>
															</div>
															<div class="row g-2">
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >DISTRICT</label>
																	<input type="text" class="form-control" id="data_DISTRICT" name="data_DISTRICT" maxlength="255">
																</div>
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >LAT</label>
																	<input type="text" class="form-control date" id="data_LAT" name="data_LAT" >
																</div>
															</div>
															<div class="row g-2">
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >LNG</label>
																	<input type="text" class="form-control date" id="data_LNG" name="data_LNG" >
																</div>
														</div>
