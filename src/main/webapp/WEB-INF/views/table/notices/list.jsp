		...
		<div class="layout-page">
			...
			<!-- Content -->
					...
					<div class="container-fluid flex-grow-1 container-p-y">
						<h4 class="fw-bold">
							<span class="text-muted fw-light">테이블</span> notices
						</h4>
						...
						<!-- Basic Buttons -->
							<div class="col-12">
								<div class="card mb-4">
									...
									<form id="searchForm" name="searchForm" action="/table/notices/list" method="post">
									...
									<div class="card-footer">
										...
										<button type="button" class="btn btn-secondary" id="searchClear" data-reset="notices">
											<span class="tf-icons bx bx-reset"></span>&nbsp; 리셋
			                            </button>
			                            <button type="button" class="btn btn-info" data-url="/table/notices/add" data-type="add"
			                            	data-bs-toggle="modal" data-bs-target="#modalData">
											<span class="tf-icons bx bx-plus"></span>&nbsp; 등록
			                            </button>
			                            <button type="button" class="btn btn-danger" data-url="/table/notices/remove">
										...
										<c:if test="${TOTAL ne 0}">
											<c:forEach var="entry" items="${LIST}" varStatus="status">
												...
												<c:set var="pageNo" value="${PAGE.total - ( (PAGE.page-1) * PAGE.rows ) - no + 1 }" />
													...
													<td class="center">
														<a href="#" class="link_modal green" data-url="/table/notices/detail" data-modaltype="detail"
												...
												<form id="dataForm" name="dataForm" action="/table/pg_code/" method="post">
													...
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="modal-title"><sapn id="modalTitle">notices</sapn></h5>
