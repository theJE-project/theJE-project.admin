		...
		<div class="layout-page">
			...
			<!-- Content -->
					...
					<div class="container-fluid flex-grow-1 container-p-y">
						<h4 class="fw-bold">
							<span class="text-muted fw-light">테이블</span> communities
						</h4>
						...
						<!-- Basic Buttons -->
							<div class="col-12">
								<div class="card mb-4">
									...
									<form id="searchForm" name="searchForm" action="/table/communities/list" method="post">
									...
									<div class="card-footer">
										...
										<button type="button" class="btn btn-secondary" id="searchClear" data-reset="communities">
											<span class="tf-icons bx bx-reset"></span>&nbsp; 리셋
			                            </button>
			                            <button type="button" class="btn btn-info" data-url="/table/communities/add" data-type="add"
			                            	data-bs-toggle="modal" data-bs-target="#modalData">
											<span class="tf-icons bx bx-plus"></span>&nbsp; 등록
			                            </button>
			                            <button type="button" class="btn btn-danger" data-url="/table/communities/remove">
										...
										<table class="table table-bordered" id="tableList">
											<thead>
												<tr>
													...
													<th class="center">updated_at</th>
													<th class="center">is_delete</th>
													<th class="center">is_visible</th>
												</tr>
											</thead>
										...
										<c:if test="${TOTAL ne 0}">
											<c:forEach var="entry" items="${LIST}" varStatus="status">
												...
												<c:set var="pageNo" value="${PAGE.total - ( (PAGE.page-1) * PAGE.rows ) - no + 1 }" />
													...
													<td class="center">
														<a href="#" class="link_modal green" data-url="/table/communities/detail" data-modaltype="detail"
															data-detailkey="id" data-detailvalue="${entry.id}"
															data-bs-toggle="modal" data-bs-target="#modalData">${entry.id}</a>
													</td>
													<td class="center">${entry.users}</td>
													<td class="center">${entry.categories}</td>
													<td class="center">${entry.title}</td>
													<td class="center">${entry.content}</td>
													<td class="center">${entry.count}</td>
													<td class="date">${entry.created_at}</td>
													<td class="date">${entry.updated_at}</td>
													<td class="center">${entry.is_delete}</td>
													<td class="center">${entry.is_visible}</td>
												</tr>
												...
												<form id="dataForm" name="dataForm" action="/table/pg_code/" method="post">
													...
													<div class="modal-content">
														<div class="modal-header">
															<h5 class="modal-title" id="modal-title"><sapn id="modalTitle">communities</sapn></h5>
														...
														<div class="modal-body">
															<div class="row g-2">
																...
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >USERS</label>
																	<input type="text" class="form-control" id="data_USERS" name="data_USERS" >
																</div>
															</div>
															<div class="row g-2">
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >CATEGORIES</label>
																	<input type="text" class="form-control" id="data_CATEGORIES" name="data_CATEGORIES" >
																</div>
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >TITLE</label>
																	<input type="text" class="form-control" id="data_TITLE" name="data_TITLE" maxlength="255">
																</div>
															</div>
															<div class="row g-2">
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >CONTENT</label>
																	<input type="text" class="form-control" id="data_CONTENT" name="data_CONTENT" maxlength="65535">
																</div>
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >COUNT</label>
																	<input type="text" class="form-control" id="data_COUNT" name="data_COUNT" >
																</div>
															</div>
															<div class="row g-2">
																<div class="col mb-0">
																...
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >UPDATED_AT</label>
																	<input type="text" class="form-control date" id="data_UPDATED_AT" name="data_UPDATED_AT"  disabled="disabled">
																</div>
															</div>
															<div class="row g-2">
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >IS_DELETE</label>
																	<input type="text" class="form-control" id="data_IS_DELETE" name="data_IS_DELETE" >
																</div>
															<div class="row g-2">
																<div class="col mb-0">
																	<label class="col-form-label" for="html5-text-input" >IS_VISIBLE</label>
																	<input type="text" class="form-control" id="data_IS_VISIBLE" name="data_IS_VISIBLE" >
																</div>
																<div class="col mb-0">
																</div>
															</div>
